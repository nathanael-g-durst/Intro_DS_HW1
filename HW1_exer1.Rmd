...
<!-- Add the justification required in the homework file : Are these results different from 1/2, 1/2 and 1/12 (their respective theoretical values)? Is this result surprising? Justify your answer.-->
...
<!-- This is certainly more complex than necessary but I couldn't find a way to include bootstrap without braking the default knitr stylesheet-->

<div style="position: relative; padding: .75rem 1.25rem 0rem 1.25rem; margin-bottom: 1rem; border: 1px solid; color: #004085; background-color: #cce5ff; border-color: #b8daff;">
  <p><strong>Alert :</strong> This is a colour box</p>
</div>
