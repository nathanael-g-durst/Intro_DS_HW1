...
Here we will talk about the mean and variance of all of the stocks' closing prices we are analyzing.
...
The variance of an equally weighted portfolio of those stocks is `r varPortfolio`.

Compared to the variance of all of the individual stocks : `r sort(c(varAAPL, varGOOG, varINTC, varHD, varCSCO, varJPM))`, we can clearly see the benefits of diversification. Only Google has a variance lower than our portfolio.
